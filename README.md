...
Each chapter is organized into two separate directories:
...
> **Note:** `mini_projects/` appears only in chapters that contain a hands-on integration project (Chapters 4, 6, and 9).
